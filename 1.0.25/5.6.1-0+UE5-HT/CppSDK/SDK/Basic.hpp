...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0E6BB200;
	constexpr int32 AppendString      = 0x015E8F40;
	constexpr int32 GNames            = 0x0E5D7080;
	constexpr int32 GWorld            = 0x0E2DBDB0;
	constexpr int32 ProcessEvent      = 0x0182C720;

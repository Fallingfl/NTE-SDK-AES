...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0EA24400;
	constexpr int32 AppendString      = 0x015FA680;
	constexpr int32 GNames            = 0x0E940280;
	constexpr int32 GWorld            = 0x0E633DB0;
	constexpr int32 ProcessEvent      = 0x0183DD10;
